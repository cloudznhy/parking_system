...
QT_MOC_LITERAL(1, 6, 24), // "now_count_changed_signal"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 17), // "parking_now_count"
QT_MOC_LITERAL(4, 50, 11), // "park_reduce"
QT_MOC_LITERAL(5, 62, 13) // "park_increase"

    },
    "mysql\0now_count_changed_signal\0\0"
    "parking_now_count\0park_reduce\0"
    "park_increase"
};
...
void mysql::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->now_count_changed_signal((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mysql::now_count_changed_signal)) {
                *result = 0;
                return;
            }
        }
