...
"border-radius:7px;"));
        ...
        parklabel->setObjectName("parklabel");
        ...
        parklabel->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);

        horizontalLayout_5->addWidget(parklabel);

        parkcomboBox = new QComboBox(gridLayoutWidget);
        parkcomboBox->setObjectName("parkcomboBox");
...
"border-radius:7px;"));
        ...
        QSizePolicy sizePolicy6(QSizePolicy::Policy::Preferred, QSizePolicy::Policy::Minimum);
        ...
        park_page->setObjectName("park_page");
        ...
        verticalLayout_park->setObjectName("verticalLayout_park");
        verticalLayout_park->setContentsMargins(0, 0, 0, 0);
        horizontalLayout_park_toolbar = new QHBoxLayout();
        horizontalLayout_park_toolbar->setObjectName("horizontalLayout_park_toolbar");
        parkAddButton = new QPushButton(layoutWidget);
        parkAddButton->setObjectName("parkAddButton");
...
"border-radius:7px;"));
        ...
        parkUpdateButton->setObjectName("parkUpdateButton");
...
"border-radius:7px;"));
        ...
        parkDeleteButton->setObjectName("parkDeleteButton");
...
"border-radius:7px;"));
        ...
        parkRefreshButton->setObjectName("parkRefreshButton");
...
"border-radius:7px;"));
        ...
        parktable->setObjectName("parktable");
        parktable->setColumnCount(6);
        ...
        parkmessage->setObjectName("parkmessage");
